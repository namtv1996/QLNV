...
$webHostFolder = Join-Path $slnFolder "src/CRM.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/CRM.Web.Public"
...
dotnet publish --output (Join-Path $outputFolder "Public")
