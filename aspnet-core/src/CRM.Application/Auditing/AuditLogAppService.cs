...
namespace CRM.Auditing
{
    ...
    public class AuditLogAppService : CRMAppServiceBase, IAuditLogAppService
    {
        ...
        public List<NameValueDto> GetEntityHistoryObjectTypes()
        {
            ...
            {
                entityHistoryObjectTypes.Add(new NameValueDto(L("CRM.MultiTenancy.Tenant"), "CRM.MultiTenancy.Tenant"));
            }

            entityHistoryObjectTypes.Add(new NameValueDto(L("CRM.MultiTenancy.Role"), "CRM.MultiTenancy.Role"));
