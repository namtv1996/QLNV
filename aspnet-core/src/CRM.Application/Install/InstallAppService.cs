...
using CRM.Migrations.Seed.Host;
...
namespace CRM.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CRMAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CRMDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(CRMConsts.ConnectionStringName).Value.ToString();
        }
