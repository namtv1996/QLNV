...
using CRM.Friendships.Cache;
using CRM.Localization;
using CRM.MultiTenancy;
using CRM.MultiTenancy.Payments.Cache;
using CRM.Notifications;
...
namespace CRM
{
    ...
    public class CRMCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CRMSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
            ...
            {
                cache.DefaultSlidingExpireTime = TimeSpan.FromMinutes(CRMConsts.PaymentCacheDurationInMinutes);
            });
        }
