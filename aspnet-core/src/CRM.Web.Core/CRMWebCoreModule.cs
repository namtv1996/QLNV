...
using CRM.Web.Authentication.TwoFactor;
using CRM.Web.Configuration;
#if FEATURE_SIGNALR
...
namespace CRM.Web
{
    ...
    public class CRMWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CRMWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CRMWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(CRMWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
