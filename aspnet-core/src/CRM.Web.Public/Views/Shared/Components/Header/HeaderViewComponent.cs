...
using CRM.Url;
using CRM.Web.Public.Startup;
using CRM.Web.Session;

namespace CRM.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CRMViewComponent
    {
